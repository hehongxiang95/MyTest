package com.example.mytest.scroll;
 ...
 * @author shaozuhceng
 */
public class OverListScrollView extends ScrollView {

	private static final String TAG = "OverListScrollView";
	...
	public OverListScrollView(Context context) {
		super(context);
	}

	public OverListScrollView(Context context, AttributeSet attrs) {
		super(context, attrs);
	}
